...
@Component({
  selector: 'cs-reusable-tables',
  standalone: true,
  imports: [FormsModule,ReactiveFormsModule,CommonModule],
  templateUrl: './cs-reusable-tables.component.html',
  styleUrl: './cs-reusable-tables.component.scss'
})
export class CsReusableTablesComponent {
  @Input() columns: any[] = [];
