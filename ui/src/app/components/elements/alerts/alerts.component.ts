...
import { CsAlertsComponent } from 'src/app/_cs/reusable-ui-elements/cs-alerts/cs-alerts.component';
...
@Component({
  ...
  imports: [PageHeaderComponent, NgbModule, ShowcodeCardComponent, CsAlertsComponent, CommonModule]
})
