...
export class ButtonsComponent {
 ...
 outlineButtons=[
  ...
  iconButtonsSizes=[
    ...
    {class:'btn btn-icon btn-warning btn-wave me-5 waves-effect waves-light',icon:'ri-calendar-2-line'},
  ]
  iconButtonsSizes1=[
    ...
    {class:'btn btn-icon btn-danger-transparent rounded-pill btn-wave me-5 waves-effect waves-light',icon:'ri-chat-settings-line'},
  ]
  iconButtonsSizes2=[
    ...
    {class:'btn btn-icon btn-outline-secondary rounded-pill btn-wave waves-effect waves-light',icon:'ri-save-line'},
  ]
  socialButtons=[
  ...
  Blockbutton3 = [
    ...
    {id:2, class:"Button", color:"btn btn-secondary"},
  ]
}
