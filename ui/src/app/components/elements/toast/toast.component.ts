...
import { CsToastComponent } from 'src/app/_cs/reusable-ui-elements/cs-toast/cs-toast.component';
...
@Component({
    ...
    imports: [PageHeaderComponent, ShowcodeCardComponent,CsToastComponent]
})
