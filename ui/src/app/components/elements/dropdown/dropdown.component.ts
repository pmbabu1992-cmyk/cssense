...
@Component({
    ...
    imports: [PageHeaderComponent, CsDropdownsComponent,NgbDropdownModule,ShowcodeCardComponent]
})
export class DropdownComponent  {
  ...
  alignmentOptions = [
    ...
    { Customclass: "btn-group dropup custom-dropup me-2", style: 'btn-teal dropdown-toggle', label: 'Dropup', menuClass: 'dropdown-menu', placement: "top-start" },
  ]
  customDropdowns = [
    {
      label: 'Primary',
