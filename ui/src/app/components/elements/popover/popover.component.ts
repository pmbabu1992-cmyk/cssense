...
import * as prismcodeData from '../../../shared/prismData/popover'
...
import { CsPopoversComponent } from 'src/app/_cs/reusable-ui-elements/cs-popovers/cs-popovers.component';
...
@Component({
    ...
    imports: [PageHeaderComponent, ShowcodeCardComponent, NgbPopover,CsPopoversComponent]
})
