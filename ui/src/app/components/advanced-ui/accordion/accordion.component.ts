...
import { NgbCollapseComponent } from 'src/app/_cs/cs-reusable-plugins/ngb-collapse/ngb-collapse.component';
...
@Component({
    ...
    imports: [PageHeaderComponent,CommonModule,NgbModule,ShowcodeCardComponent,NgbAccordionComponent,NgbCollapseComponent]
})
