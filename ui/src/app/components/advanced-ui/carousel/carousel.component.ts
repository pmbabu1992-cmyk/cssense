...
import { NgbCarouselComponent } from 'src/app/_cs/cs-reusable-plugins/ngb-carousel/ngb-carousel.component';
...
@Component({
    ...
    imports: [PageHeaderComponent,ShowcodeCardComponent,NgbCarouselComponent]
})
