...
import { MatTreeFlatDataSource, MatTreeFlattener, MatTreeNestedDataSource, MatTree, MatTreeNodeDef, MatTreeNode, MatTreeNodeToggle, MatNestedTreeNode, MatTreeNodeOutlet } from '@angular/material/tree';
...
@Component({
    ...
    imports: [PageHeaderComponent, MatTree, MatTreeNodeDef, MatTreeNode, MatTreeNodeToggle, MatNestedTreeNode, MatIcon, MatTreeNodeOutlet]
})
