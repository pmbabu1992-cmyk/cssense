...
import { NgbDropdown, NgbDropdownToggle, NgbDropdownMenu, NgbDropdownItem, NgbCollapse, NgbModule } from '@ng-bootstrap/ng-bootstrap';
import { CommonModule, NgClass } from '@angular/common';
import { CsAlignmentCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-alignment-card/cs-alignment-card.component';
import { CsBgcolorCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-bgcolor-card/cs-bgcolor-card.component';
import { CsBlockquoteCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-blockquote-card/cs-blockquote-card.component';
import { CsBorderCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-border-card/cs-border-card.component';
import { CsCardgroupsCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-cardgroups-card/cs-cardgroups-card.component';
...
import { CsCustomCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-custom-card/cs-custom-card.component';
import { CsFeaturedCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-featured-card/cs-featured-card.component';
import { CsGridcardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-gridcard/cs-gridcard.component';
import { CsGridmarkupCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-gridmarkup-card/cs-gridmarkup-card.component';
import { CsHeaderFooterCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-header-footer-card/cs-header-footer-card.component';
import { CsHorizontalCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-horizontal-card/cs-horizontal-card.component';
import { CsImageCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-image-card/cs-image-card.component';
import { CsLinkCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-link-card/cs-link-card.component';
import { CsListgroupCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-listgroup-card/cs-listgroup-card.component';
import { CsMediaCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-media-card/cs-media-card.component';
import { CsMountainsCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-mountains-card/cs-mountains-card.component';
import { CsNavigationCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-navigation-card/cs-navigation-card.component';
import { CsNewsCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-news-card/cs-news-card.component';
import { CsOverlayCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-overlay-card/cs-overlay-card.component';
import { CsReviewCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-review-card/cs-review-card.component';
import { CsTitleCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-title-card/cs-title-card.component';
import { CsUtilitiesCardComponent } from 'src/app/_cs/reusable-ui-elements/cs-cards/cs-utilities-card/cs-utilities-card.component';
...
@Component({
    ...
    imports: [SharedModule,NgbModule,CsImageCardComponent,CsLinkCardComponent,
      CommonModule,CsHorizontalCardComponent,CsBgcolorCardComponent,CsFeaturedCardComponent,CsBlockquoteCardComponent,
      CsAlignmentCardComponent,CsMountainsCardComponent,CsGridmarkupCardComponent,CsOverlayCardComponent,CsTitleCardComponent,CsNewsCardComponent,CsMediaCardComponent,
      CsHeaderFooterCardComponent,CsCustomCardComponent,CsReviewCardComponent,CsBorderCardComponent,CsCardgroupsCardComponent,CsGridcardComponent,CsUtilitiesCardComponent,CsNavigationCardComponent,CsCollapseCardComponent,CsListgroupCardComponent],
})
...
getSanitizedSVG(svgContent: string): SafeHtml {
  ...
  customCard = [
    {
      ...
      bodyText: 'If you are going to use, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators.Lorem Ipsum is therefore always free.',
      footerLeftText: '28,Nov 2025',
  ...
  titleCard = [ 
    ...
    },
    {
      ...
      links: [
        ...
        { text: 'Another link', href: 'javascript:void(0);', class: 'text-secondary me-2' }
      ]
    }
  ];
  markupCard = [
  ...
  gridCards = [
   
    {
      ...
      title: 'Morphology of Black Coffee.',
    ...
    {
      imageUrl: './assets/images/media/media-78.jpg',
