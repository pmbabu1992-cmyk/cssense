...
import { AngularMaterialReusableTableComponent } from 'src/app/_cs/angular-material-reusable-table/angular-material-reusable-table.component';
...
@Component({
  ...
  imports: [PageHeaderComponent,AngularMaterialReusableTableComponent,MaterialModuleModule],
