...
// Loose schema to read ALL existing fields from the 'organizations' collection.
...
const schema = new Schema({}, { strict: false, timestamps: true, collection: 'organizations' });
